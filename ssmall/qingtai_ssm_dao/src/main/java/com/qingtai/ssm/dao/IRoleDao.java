...
public interface IRoleDao {
    ...
    @Results({
            ...
            @Result(property = "permissions",column = "id",javaType = java.util.List.class,
                    many = @Many(select = "com.qingtai.ssm.dao.IPermissionDao.findPermissionByRoleId"))
    })
    ...
    @Results({
            ...
            @Result(property = "permissions",column = "id",
                    javaType = java.util.List.class,many = @Many(select = "com.qingtai.ssm.dao.IPermissionDao.findPermissionByRoleId"))
    })
